...
@Mod(cd_worldgen.MODID)
public class cd_worldgen {

    public static final Logger LOGGER = LogManager.getLogger();
    public static final String MODID = "cd_worldgen";
    ...
    public void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld){
            ...
            try {
                ...
                cd_worldgen.LOGGER.error("Was unable to check if " + serverWorld.dimension().location() + " is using Terraforged's ChunkGenerator.");
            }
            ...
            tempMap.putIfAbsent(STStructures.RUN_DOWN_BASE.get(), DimensionStructuresSettings.DEFAULTS.get(STStructures.RUN_DOWN_BASE.get()));
