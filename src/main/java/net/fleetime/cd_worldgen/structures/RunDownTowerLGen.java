package net.fleetime.cd_worldgen.structures;

import com.mojang.serialization.Codec;
import net.fleetime.cd_worldgen.cd_worldgen;
...
public class RunDownTowerLGen extends Structure<NoFeatureConfig> {
    public RunDownTowerLGen(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return RunDownTowerLGen.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(cd_worldgen.MODID, "run_down_tower_lgen/start_pool")),
            ...
            /*
            cd_worldgen.LOGGER.log(Level.DEBUG, "Rundown Tower at " +
